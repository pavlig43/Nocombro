...
abstract class FilesComponent(
    ...
    /**
     * У части экранов, например у записей экспериментов, нет кнопки сохранения
     * родительской формы. Им нужно писать метаданные файлов сразу после правки списка.
     */
    ...
    /**
     * Строит стабильный ключ объекта для удалённого хранилища.
     *
