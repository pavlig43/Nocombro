...
fun PersonMovementsSection(
    person: ua.wwind.table.sample.model.Person,
    useCompactMode: Boolean = false,
    modifier: Modifier = Modifier,
) {
    val columns =
        remember(useCompactMode) {
            ua.wwind.table.sample.column.createMovementColumns(useCompactMode)
        }
    ...
    val movementState =
        rememberTableState(
            columns = ua.wwind.table.sample.model.PersonMovementColumn.entries.toImmutableList(),
